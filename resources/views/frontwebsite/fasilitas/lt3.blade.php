...
@section('content')
    <div>
        ...
        <div class="media container" data-aos="fade-left" data-aos-delay="150" data-aos-duration="1000"
            ...
            <div class="col-6">
                <div class="contain">
                    <div><img src="{{asset('img/aula/1.jpg')}}" class="imh imgal1"
                              style="width:100%;height: 355px"></div>
                    <a class="overlay" href="{{asset('img/aula/1.jpg')}}" data-lightbox="gallery01"
                       data-title="wdadasdadawdw">
                        <div class="poptext"><i class="fa fa-search fa-5x"></i></div>
                    </a>
                </div>
            </div>
            <a href="{{asset('img/aula/2.jpg')}}" data-title="wdadasdadawdw" data-lightbox="gallery01"></a>
            <a href="{{asset('img/aula/3.jpg')}}" data-title="wdadasdadawdw" data-lightbox="gallery01"></a>
            <a href="{{asset('img/aula/4.jpg')}}" data-title="wdadasdadawdw" data-lightbox="gallery01"></a>
            <div class="media-body col-7">
                <h5 class="mt-0" style="font-size: 35px;margin-bottom: 20px;">Aula</h5>
                <p>Sebagai sarana untuk melakukan segala agenda atau kegiatan seperti rapat, acara kegiatan,dll</p>
            </div>
        </div>
