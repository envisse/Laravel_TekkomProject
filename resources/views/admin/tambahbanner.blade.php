...
@section('tab-tab-section') Tambah banner @endsection
...
@section('content')
    ...
    <form action="{{'/administrator/banner/tambah-banner/new'}}" method="post" enctype="multipart/form-data">
        @csrf
        <tr>
            <td>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-5">
                            <input type="text" class="form-control" placeholder="Url"
                                   name="url" aria-label="Nama" aria-describedby="basic-addon1">
            </td>
            <td></td>
