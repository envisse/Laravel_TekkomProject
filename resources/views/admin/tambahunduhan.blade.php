...
@section('tab-tab-section') Tambah Link E-book @endsection

@section('content')
    <form action="{{'/administrator/e-book/tambah/new'}}" method="post" enctype="multipart/form-data">
        @csrf
        <tr>
            <td>
                <div class="container mt-3">
                    <div class="row" style="margin-bottom:20px">
                        ...
                        <div class="col-md-4">
                            <input type="text" class="form-control" placeholder="Nama" name="nama" aria-label="Nama"
            ...
            <div class="row" style="margin-bottom:20px">
                ...
                <div class="col-md-4">
                    <input type="text" class="form-control" name="url" placeholder="Url" aria-label="Nama"
