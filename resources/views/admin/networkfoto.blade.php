    ...
    <div class="container mt-4">
        <div class="d-flex justify-content-between">
            <div class="d-flex justify-content-start">
                @if(count($fotos)<14)
                    <a type="button" href="{{'/administrator/fotonetwork/showadd'}}"
        ...
        @if(count($fotos) > 0)
            <div class="row">
                @foreach($fotos as $foto)
                    <div class="col-sm-4 ">
                        <div class="card mb-1">
                            <img class="card-img-top" src="/source/ops_jaringan/{{$foto->path_foto}}" alt=""
                                 style="height:200px">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-3">
                                        <a class="fa fa-trash" style="font-size: 205.5%;color: red;"
                                           href="{{'/administrator/fotonetwork/delete/'.$foto->id}}"
