...
@section('content')
    ...
    <form action="{{'/administrator/network/edit/save/'.$network->id}}" method="post" enctype="multipart/form-data">
        @csrf
                    ...
                    <div class="row" style="margin-bottom:20px">
                        ...
                        <div class="col-md-5">
                            <input type="text" class="form-control" placeholder="nama sekolah" name="sekolah"
                                   aria-label="Nama" value="{{$network->nama_sekolah}}"
                    ...
                    <div class="row" style="margin-bottom:20px">
                        ...
                        <div class="col-md-5">
                            <input type="text" class="form-control" placeholder="Kota" name="kota" aria-label="Nama"
                                   aria-describedby="basic-addon1" value="{{$network->kota_sekolah}}"
                                   required>
                        </div>
                        <div class="col-md-3"></div>
                    </div>
