...
@section('tab-tab-section') Tambah Pegawai @endsection

@section('content')
    <script src="https://ajax.googleapis.com/ajax/libs/jquery/1.11.2/jquery.min.js"></script>
            <form action="{{'/administrator/account/tambah-account/new'}}" method="post" enctype="multipart/form-data">
            @csrf
                <tr>
                    <td>
                        <div class="container mt-3">
                            <div class="row">
                                ...
                                <div class="col-md-5">
                                    <input type="text" class="form-control" placeholder="NIP" aria-label="Nama" name="nik" aria-describedby="basic-addon1"></td><br>
                    <input type="text" class="form-control" placeholder="Nama" aria-label="Nama" name="nama_pegawai" aria-describedby="basic-addon1"></td><br>
                    <input type="password" class="form-control" placeholder="Password" name="password" aria-label="Nama" aria-describedby="basic-addon1"></td><br>
